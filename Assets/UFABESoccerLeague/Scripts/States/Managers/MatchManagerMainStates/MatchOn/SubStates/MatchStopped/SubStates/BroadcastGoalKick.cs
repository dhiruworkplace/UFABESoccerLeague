...
{
    public class BroadcastGoalKick : BState
    {
        /// <summary>
        ...
        public override void Execute()
        {
            ...
            if (waitTime <= 0f)
            {
                ((IState)Machine).Machine.ChangeState<WaitForGoalKickToComplete>();
            }
        }
        ...
        /// </summary>
        public void RaiseTheGoalKickEvent()
        {
            //prepare an empty string
            string message = "Goal Kick";
