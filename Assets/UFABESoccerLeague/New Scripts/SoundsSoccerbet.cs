...
public class SoundsSoccerbet : MonoBehaviour
{
    public static SoundsSoccerbet instance;
    ...
    {
        if (a_music != null && SoccerbetApp.music.Equals(1))
            a_music.Play();
    }
    ...
    {
        if (a_sound != null && SoccerbetApp.sound.Equals(1))
