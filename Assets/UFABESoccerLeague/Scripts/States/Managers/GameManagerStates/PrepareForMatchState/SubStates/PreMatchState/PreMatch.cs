...
using Assets.UFABESoccerLeague_.Scripts.States.Managers.GameManagerStates.PrepareForMatchState.SubStates.PreMatchState.SubStates;
using RobustFSM.Base;

namespace Assets.UFABESoccerLeague_.Scripts.States.Managers.GameManagerStates.PrepareForMatchState.SubStates
{
    public class PreMatch : BHState
    {
        ...
        public override void Enter()
        {
            ...
            // Me Added
            UIHandler.Instance.CharactersMenu.gameObject.SetActive(false);
            UIHandler.Instance.ActivePlayImage();
        }
