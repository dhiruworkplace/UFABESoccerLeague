...
namespace Assets.UFABESoccerLeague_.Scripts.States.Managers.GameManagerStates.GameOnState.SubStates
{
    public class MatchTeamManagement : BState
    {
        ...
        public void OnSelectUserTeamFormationManagement()
        {
            ...
            GraphicsManager.Instance.GameOnMainMenu.MatchPausedMenu.TeamManagementMenu.UserTeamManagementWidget.SquadRoot.SetActive(false);
            GraphicsManager.Instance.GameOnMainMenu.MatchPausedMenu.TeamManagementMenu.UserTeamManagementWidget.FormationRoot.SetActive(true);
            GraphicsManager.Instance.GameOnMainMenu.MatchPausedMenu.TeamManagementMenu.UserTeamManagementWidget.TacticsRoot.SetActive(false);
        }
        ...
        public void OnSelectUserTeamSquadManagement()
        {
            ...
            // enable and disable appropriate ui elements
            GraphicsManager.Instance.GameOnMainMenu.MatchPausedMenu.TeamManagementMenu.UserTeamManagementWidget.SquadRoot.SetActive(true);
            GraphicsManager.Instance.GameOnMainMenu.MatchPausedMenu.TeamManagementMenu.UserTeamManagementWidget.FormationRoot.SetActive(false);
            GraphicsManager.Instance.GameOnMainMenu.MatchPausedMenu.TeamManagementMenu.UserTeamManagementWidget.TacticsRoot.SetActive(false);
        }
        ...
        public void OnSelectUserTeamTacticManagement()
        {
            ...
            GraphicsManager.Instance.GameOnMainMenu.MatchPausedMenu.TeamManagementMenu.UserTeamManagementWidget.SquadRoot.SetActive(false);
            GraphicsManager.Instance.GameOnMainMenu.MatchPausedMenu.TeamManagementMenu.UserTeamManagementWidget.FormationRoot.SetActive(false);
            GraphicsManager.Instance.GameOnMainMenu.MatchPausedMenu.TeamManagementMenu.UserTeamManagementWidget.TacticsRoot.SetActive(true);
        }
        ...
        public void OnSelectUserTeamFormation(string formationType)
        {
            ...
            GraphicsManager.Instance.GameOnMainMenu.MatchPausedMenu.TeamManagementMenu.UserTeamManagementWidget
