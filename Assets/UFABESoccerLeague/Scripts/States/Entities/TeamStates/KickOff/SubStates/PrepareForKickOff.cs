...
namespace Assets.UFABESoccerLeague.Scripts.States.Entities.TeamStates.KickOff.SubStates
{
    public class PrepareForKickOff : BState
    {
        ...
        void PlaceKickOffTakerAtTakeKickOffPosition()
        {
            ...
            teamPlayer.CurrentHomePosition.position = Pitch.Instance.CenterSpot.position + (Owner.Goal.transform.forward * (teamPlayer.Player.BallContrallableDistance + teamPlayer.Player.Radius));
            ...
            teamPlayer.Player.HomePosition = Owner.KickOffRefDirection;
